...
const UrlShortener = () => {
  ...
  return (
    ...
    <input type="text" id="fname" name="custom" placeholder="custamize it (optional) " onChange={handleChange}/>
    ...
    <Dialog open={open} onClose={handleClose} aria-labelledby="alert-dialog-title" aria-describedby="alert-dialog-description">
        ...
        <Alert severity="success">Url Shortned - valid for 30mins</Alert>
        </DialogTitle>
        <DialogContent>
